...
class Major_Chords(Menu):
    ...
    def display_menu(self):
        ...
        while self.run_display:
            ...
            self.game.draw_text("D Major", 15, self.minox, self.minoy)
            self.game.draw_text("E Major", 15, self.minox, self.minoy)
            self.game.draw_text("F Major", 15, self.minox, self.minoy)
            self.game.draw_text("G Major", 15, self.minox, self.minoy)
            self.game.draw_text("A Major", 15, self.minox, self.minoy)
            self.game.draw_text("B Major", 15, self.minox, self.minoy)
            self.draw_cursor()
            self.blit_screen()
